...
const Register = () => {
  ...
  const API_URL = 'http://localhost:5000/api/users'; // Registration endpoint
  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      navigate('/dashboard/job-posting-form'); // Navigate to dashboard after successful registration
    } catch (err) {
